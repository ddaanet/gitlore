...
- Compact the `MEMORY.md` index, at ~23KB against the 24.4KB read-truncation limit. Needs an adversarial audit of the diff per `feedback_index_compaction_triggers` — don't trim solo, and don't rush it under time pressure either.
