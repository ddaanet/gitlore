...
3. **`brief-memory-index-glued-bullets.md`** — a glued-bullet rule in
...
4. **`brief-hook-exec-and-compose-revert.md`, defect 1** — the installer
   ...
   path.
5. **`brief-orphaned-merge-head-no-state-file.md`** (root) — merge core.
   ...
   before writing code.
6. **`brief-hook-exec-and-compose-revert.md`, defect 2** — composition
...
7. **`brief-handoff-integration-evals.md`** — largest by effort, lowest blast
