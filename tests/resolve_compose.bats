...
- [T](ddaanet/x.md) — org'
  ...
  # And the root-authored tier line was mirrored DOWN into the carrier.
  grep -qxF -- '- [T](x.md) — org' memory/ddaanet/MEMORY.md
  # That carrier write lands in another store, so it stays dirty and rides the
  # next FR11 commit — the same float the SessionStart recompose produces.
