...
Feature-complete: all functional requirements and design decisions (D1–D15) in
...
- **Dogfood-driven hardening (D12–D15)** ✅ (submodule-side commit gate; git lock-contention retry; SessionStart output on `systemMessage`; in-process-worktree memory-drift guard)
