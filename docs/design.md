...
*Status: design revised 2026-07-14 (sync corrected to one-way index→frontmatter 2026-07-15) — grounded and converged, not yet implemented. Implementation sequence: (1) authoring-time one-way sync (index→frontmatter), (2) one-time reconcile (dogfood here first), (3) structural recompose + first nested tier.*
